...
class Enviroment:
    def __init__(self):
        ...
        self.SERVO_TIME_DELAY_MAX = .2

        self.ACTION_REWARD_FACTOR = 1
        self.ACTION_REWARD_MAX = 1.5
    ...
    def step(self, action):
        ...
        new_state = [self._get_accel_avg(), self.servo_1_pos]
